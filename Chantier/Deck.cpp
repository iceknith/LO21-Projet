...
TuileJeu* Deck::tirer_tuile(){
    if (nombreTuiles < 1) throw AkropolisException ("Le deck est vide");
    nombreTuiles--;
...
TuileJeu** Deck::tirer_tuiles(size_t nombre_tuiles){
    if (nombreTuiles < nombre_tuiles) throw AkropolisException("Le deck ne contient pas assez de tuiles");
